...
#===== LINK : https://www.facebook.com/devilarmanjani
#▬▭▬▭▬▭▬▭[IMPORT]▬▭▬▭▬▭▬▭#
...
try:
    ...
    print(f"{style} \033[1;32mSYCO-MR D3V1L  TOOL IS NOT ALLOW WITHOUT STORAGE PERMISSION");os.system('termux-setup-storage');os.system('clear');exit(f"{style} \033[1;32mRUN AGAIN : python AUTO.py")
#▬▭▬▭▬▭▬▭[INTERNET]▬▭▬▭▬▭▬▭#
try:
...
uid=os.getuid()
key1=open('/data/data/com.termux/files/usr/bin/.errorauto.txt', 'r').read()
kex=(f"CLONEFB|MR|{uid}|SYCO|{key1}|708")
key1=kex
...
logo=(Colorate.Horizontal(Colors.green_to_white, """
         __  __  ____    ____  ____  _  _  ____  __   
(  \/  )(  _ \  (  _ \( ___)( \/ )(_  _)(  )  
 )    (  )   /   )(_) ))__)  \  /  _)(_  )(__ 
(_/\/\_)(_)\_)  (____/(____)  \/  (____)(____)    •XD """" MR D3V1L "))
info=(f"""{style} \033[1;32mAUTHOR   \033[1;37m: \033[1;32mMR D3V1L  XD
{style} \033[1;32mFACEBOOK \033[1;37m: \033[1;32m𝐃𝐄𝐕𝐈𝐋 ⸙ 3:)
{style} \033[1;32mSC SEND   \033[1;37m: \033[1;32mMR D3V1L  XD
...
#▬▭▬▭▬▭▬▭[INFO]▬▭▬▭▬▭▬▭#
def main_logo():
   os.system("xdg-open https://www.facebook.com/devilarmanjani ");os.system("clear" if os.name == "posix" else "cls");print(logo);linex();print(info);linex()
#▬▭▬▭▬▭▬▭[LOOP]▬▭▬▭▬▭▬▭#
  ...
  async with aiohttp.ClientSession() as sess:
    async with sess.get('https://pastebin.com/5wE9EWr6') as appro:
      ...
      if key1 in r1:
        ...
        time.sleep(3.5)
        tks=f"""HELLO MR D3V1L , DEAR ADMIN, PLEASE APPROVE MY KEY TO PREMIUM THANKS.\nYOUR KEY : {key1}"""
        msg=urllib.parse.quote(tks)
        os.system(f'am start -a Jone gurop 'f'-d "https://www.facebook.com/devilarmanjani"')
        await sub()
#▬▭▬▭▬▭▬▭[MAIN MENU]▬▭▬▭▬▭▬▭#
def main():
    main_logo();print(f'\033[1;37m[\033[1;32mA\033[1;37m]\033[1;32m START CLONE FACEBOOK');print(f'\033[1;37m[\033[1;32mO\033[1;37m]\033[1;31m EXIT THIS PROGRAM');linex()
...
def ____create____():
    ...
    main_logo();print(f'''{style} \033[1;32mTOTAL CLONE LIMIT \033[1;37m:\033[1;32m {num_accounts}''');print(f'''{style} \033[1;32mIF NO RESULT \033[1;37m[\033[1;32mON\033[1;37m/\033[1;31mOFF\033[1;37m] \033[1;32mAIRPLANE MODE OR USE 1.1.1.1 VPN''');linex()
    for make in range(int(num_accounts)):
        make+1
        sys.stdout.write(f"\r\r\033[1;37m[\033[1;32mMR D3V1L -M1\033[1;37m]\033[1;37m-\033[1;37m[\033[1;32m{make}\033[1;37m]\033[1;37m-\033[1;37m[\033[1;32mOK\033[1;37m•\033[1;32m{len(oks)}\033[1;37m]\033[1;37m-\033[1;37m[\033[1;31mCP\033[1;37m•\033[1;31m{len(cps)}\033[1;37m]\033[1;37m-\033[1;37m[\033[1;32m{'{:.1%}'.format(make/int(num_accounts))}\033[1;37m]");sys.stdout.flush()
...
def confirm_id(mail,uid,otp,data,ses,random_password):
    try:
        ...
        if "checkpoint" in str(response.url):
            ...
            #print(f"\r\r\033[1;37m[\033[1;32mSUCCESS-MR D3V1L 💚\033[1;37m] \033[1;32m{uid} \033[1;31m» \033[1;32m{random_password} \033[1;31m» \033[1;32m{otp}")
            print(f"\r\r\033[1;37m[\033[1;32mSUCCESS-MR D3V1L 💚\033[1;37m] \033[1;32m{uid} \033[1;31m» \033[1;32m{random_password}")
            try:open("/sdcard/MR D3V1L -CLONE-M1-COOKIE.txt","a").write(uid+"|"+random_password+"|"+otp+"|"+cookie_string+"\n");open("/sdcard/MR D3V1L -CLONE-M1-OK.txt","a").write(uid+"|"+random_password+"\n");open("/sdcard/MR D3V1L -CLONE-M1-EMAIL.txt","a").write(mail+"\n")
